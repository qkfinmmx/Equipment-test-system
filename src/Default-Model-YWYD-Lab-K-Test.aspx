<%@ Page Title="一维运动控制实验台本体控制箱检测" Language="C#" MasterPageFile="~/MasterTestModel.master" AutoEventWireup="true" CodeFile="Default-Model-YWYD-Lab-K-Test.aspx.cs" Inherits="Default_Model_YWYD_Lab_K_Test" %>

<asp:Content ID="Contenthead" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript" src="js/Ajax_YWYD_K.js"></script>
</asp:Content>
