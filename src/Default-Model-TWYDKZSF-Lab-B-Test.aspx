<%@ Page Title="二维运动控制实验台(伺服)本体" Language="C#" MasterPageFile="~/MasterTestModel.master" AutoEventWireup="true" CodeFile="Default-Model-TWYDKZSF-Lab-B-Test.aspx.cs" Inherits="Default_Model_TWYDKZSF_Lab_B_Test" %>

<asp:Content ID="Contenthead" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript" src="js/Ajax_TWYDKZSF_B.js"></script>
</asp:Content>
