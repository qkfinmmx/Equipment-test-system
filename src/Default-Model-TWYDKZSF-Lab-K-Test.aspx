<%@ Page Title="二维运动控制实验台(伺服)控制箱检验" Language="C#" MasterPageFile="~/MasterTestModel.master" AutoEventWireup="true" CodeFile="Default-Model-TWYDKZSF-Lab-K-Test.aspx.cs" Inherits="Default_Model_TWYDKZSF_Lab_K_Test" %>

<asp:Content ID="Contenthead" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript" src="js/Ajax_TWYDKZSF_K.js"></script>
</asp:Content>
