...
$(document).ready(function () {
        ...
        if ($("#tabsConstantdiv").css("display") == "none") {
            $.ajax({
                ...
                data: { c1: $('input[name="check1"]:checked').val(),
                    ...
                    c11: $('input[name="check11"]:checked').val(),
                    c12: $('input[name="check12"]:checked').val(),
                    c13: $('input[name="check13"]:checked').val(),
                    c14: $('input[name="check14"]:checked').val(),
                    c15: $('input[name="check15"]:checked').val(),
                    c16: $('input[name="check16"]:checked').val(),
                    c17: $('input[name="check17"]:checked').val(),
                    c18: $('input[name="check18"]:checked').val()
                },
                datatype: "json",
                success: function (obj) {
                    ...
                    divrunathtml = divrunathtml.replace("$总体结论$", data[20].toString());
    ...
    $("#ButtonPrint").click(function () {
        if (g_flag == 0) {
            ...
            g_data.push("CKDLSYX-LAB-TEMPLATE.html");
            g_flag = 1;
        }
        $.ajax({
            type: "post",
