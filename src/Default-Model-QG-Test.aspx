<%@ Page Title="球杆系统实验台检验" Language="C#" MasterPageFile="~/MasterTestModel.master" AutoEventWireup="true" CodeFile="Default-Model-QG-Test.aspx.cs" Inherits="Default_Model_QG_Test" %>

<asp:Content ID="Contenthead" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript" src="js/Ajax_QG.js"></script>
</asp:Content>
